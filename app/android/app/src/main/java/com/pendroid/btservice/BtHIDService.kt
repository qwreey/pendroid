...
class BtHIDService(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    private val HID_DESCRIPTOR by lazy { intArrayOf(
        ...
        0x09, 0x30, // Usage (X)
        0x15, 0x00,       // Logical Minimum (0)
        0x26, *intToLittleEndianBytes(DISPLAY_METRICS.widthPixels, 2), // Logical Maximum (width)
        0x35, 0x00,       // Physical Minimum (0)
        0x46, *intToLittleEndianBytes(DISPLAY_METRICS.widthPixels, 2), // Physical Maximum (width)
        0x55, 0x0E,       // Unit Exponent (-2)
        ...
        0x09, 0x31, // Usage (Y)
        0x15, 0x00,       // Logical Minimum (0)
        0x26, *intToLittleEndianBytes(DISPLAY_METRICS.heightPixels, 2), // Logical Maximum (height)
        0x35, 0x00,       // Physical Minimum (0)
        0x46, *intToLittleEndianBytes(DISPLAY_METRICS.heightPixels, 2), // Physical Maximum (height)
        0x55, 0x0E,       // Unit Exponent (-2)
        0x65, 0x13,       // Unit (Inch,EngLinear)
        0x75, 0x10, // Report Size (16)
        0x95, 0x01, // Report Count (1)
    ...
    private val HID_QOS by lazy { BluetoothHidDeviceAppQosSettings(
    ...
    private val HID_SDP by lazy { BluetoothHidDeviceAppSdpSettings(
        "Pendroid",
