...
class MainApplication : Application(), ReactApplication {
    private inner class ReactNativeHostWithPackages(app: MainApplication): DefaultReactNativeHost(app) {
    ...
    override val reactNativeHost: ReactNativeHost = ReactNativeHostWithPackages(this)
